...
class LengthConstrainedBeamSearch(Search):
    def __init__(self, data_utils, min_len_a, min_len_b, max_len_a, max_len_b):
        super().__init__(data_utils)
        self.min_len_a = min_len_a
        self.min_len_b = min_len_b
        self.max_len_a = max_len_a
        self.max_len_b = max_len_b
        self.beam = BeamSearch(data_utils)
...
class DiverseBeamSearch(Search):
    ...
    def __init__(self, data_utils, num_groups, diversity_strength):
        super().__init__(data_utils)
...
class Sampling(Search):
    ...
    def __init__(self, data_utils, sampling_topk=-1, sampling_topp=-1.0):
        super().__init__(data_utils)
...
class DiverseSiblingsSearch(Search):
    ...
    def __init__(self, data_utils, diversity_rate):
        super().__init__(data_utils)
